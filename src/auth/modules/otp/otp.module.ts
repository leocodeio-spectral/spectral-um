...
} from 'src/auth/modules/user/application/services/user-authentication.service';
import {
  CreatorRegistrationService,
  EditorRegistrationService,
} from 'src/auth/modules/user/application/services/user-registration.service';
import {
...
} from 'src/auth/modules/user/infrastructure/adapters/user.repository';
import {
  ICreatorPreferencesPort,
  IEditorPreferencesPort,
} from 'src/auth/modules/user/domain/ports/user-preferences.port';
import {
  CreatorPreferencesRepositoryAdapter,
  EditorPreferencesRepositoryAdapter,
} from 'src/auth/modules/user/infrastructure/adapters/user-preferences.repository';
import {
  creatorsProvider,
  editorsProvider,
} from 'src/auth/modules/user/infrastructure/providers/users.provider';
