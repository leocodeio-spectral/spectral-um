...
import { CreatorOtpModule, EditorOtpModule } from 'src/auth/modules/otp/otp.module';
import {
  CreatorAuthService,
  EditorAuthService,
...
import { SessionRepositoryAdapter } from 'src/auth/modules/session/infrastructure/adapters/session.repository';
import { IOtpPort } from 'src/auth/modules/otp/domain/ports/otp.port';
import { OTPRepositoryAdaptor } from 'src/auth/modules/otp/infrastructure/adapters/otp.repository';
import {
  creatorsProvider,
  editorsProvider,
} from '../user/infrastructure/providers/users.provider';
import { sessionProvider } from 'src/auth/modules/session/infrastructure/providers/session.provider';
import { otpProvider } from 'src/auth/modules/otp/infrastructure/providers/session.provider';
