...
import { UserRepositoryAdapter } from 'src/modules/user/infrastructure/adapters/user.repository';
import { IUserPreferencesPort } from 'src/modules/user/domain/ports/user-preferences.port';
import { UserPreferencesRepositoryAdapter } from 'src/modules/user/infrastructure/adapters/user-preferences.repository';
import { usersProvider } from 'src/modules/user/infrastructure/providers/users.provider';
